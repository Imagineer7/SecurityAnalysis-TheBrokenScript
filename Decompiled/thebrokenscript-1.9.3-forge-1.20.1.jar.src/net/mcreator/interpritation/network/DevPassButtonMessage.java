...
/*    */ import net.mcreator.interpritation.procedures.DevCheckProcedure;
...
/*    */ public class DevPassButtonMessage {
...
/*    */   }
/*    */   
/*    */   public static void buffer(DevPassButtonMessage message, FriendlyByteBuf buffer) {
...
/*    */   }
/*    */   
/*    */   public static void handler(DevPassButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
...
/* 61 */     HashMap guistate = DevPassMenu.guistate;
/*    */     
/* 63 */     if (!world.m_46805_(new BlockPos(x, y, z)))
/*    */       return; 
/* 65 */     if (buttonID == 0)
/*    */     {
/* 67 */       DevCheckProcedure.execute((LevelAccessor)world, x, y, z, guistate);
/*    */     }
/*    */   }
/*    */   
/*    */   @SubscribeEvent
/*    */   public static void registerMessage(FMLCommonSetupEvent event) {
/* 73 */     ThebrokenscriptMod.addNetworkMessage(DevPassButtonMessage.class, DevPassButtonMessage::buffer, DevPassButtonMessage::new, DevPassButtonMessage::handler);
/*    */   }
/*    */ }
