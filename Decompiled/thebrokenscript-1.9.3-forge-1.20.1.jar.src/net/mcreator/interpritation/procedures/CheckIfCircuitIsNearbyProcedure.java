...
/*    */ 
/*    */ @EventBusSubscriber
/*    */ public class CheckIfCircuitIsNearbyProcedure
/*    */ {
/*    */   @SubscribeEvent
...
/* 27 */     execute(null, world, x, y, z);
/*    */   }
/*    */   
/*    */   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
/* 31 */     if (world.m_6443_(CircuitEntity.class, AABB.m_165882_(new Vec3(x, y, z), 1000.0D, 1000.0D, 1000.0D), e -> true).isEmpty()) {
/* 32 */       (ThebrokenscriptModVariables.MapVariables.get(world)).nowayoutframe = 0.0D;
...
/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3-forge-1.20.1.jar!\net\mcreator\interpritation\procedures\CheckIfCircuitIsNearbyProcedure.class
