...
/*    */ import net.mcreator.interpritation.procedures.ForcerandomeventProcedure;
...
/* 23 */     event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.m_82127_("TBS_forcerandomevent").requires(s -> s.m_6761_(4))).executes(arguments -> {
...
/*    */             ForcerandomeventProcedure.execute((LevelAccessor)world, x, y, z, (Entity)fakePlayer);
/*    */             return 0;
/*    */           }));
/*    */   }
/*    */ }
...
/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3-forge-1.20.1.jar!\net\mcreator\interpritation\command\ForceEventCommand.class
