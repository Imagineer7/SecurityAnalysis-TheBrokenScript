...
/*    */ import net.mcreator.interpritation.procedures.RepsystemindevelopmentProcedure;
...
/*    */ 
/*    */ @EventBusSubscriber
/*    */ public class RepdebugCommand {
/*    */   @SubscribeEvent
/*    */   public static void registerCommand(RegisterCommandsEvent event) {
/* 21 */     if (event.getCommandSelection() == Commands.CommandSelection.INTEGRATED)
/* 22 */       event.getDispatcher().register((LiteralArgumentBuilder)Commands.m_82127_("TBS_entitiesreputationdebug")
/*    */           
/* 24 */           .executes(arguments -> {
...
/*    */               RepsystemindevelopmentProcedure.execute((LevelAccessor)world, x, y, z);
/*    */               return 0;
/*    */             })); 
/*    */   }
/*    */ }
...
/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3-forge-1.20.1.jar!\net\mcreator\interpritation\command\RepdebugCommand.class
