...
/*    */ import net.mcreator.interpritation.procedures.ConfigcommandopenProcedure;
...
/*    */ 
/*    */ @EventBusSubscriber
/*    */ public class TbsConfigCommand {
/*    */   @SubscribeEvent
/*    */   public static void registerCommand(RegisterCommandsEvent event) {
/* 23 */     event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.m_82127_("TBS_config").requires(s -> s.m_6761_(2))).executes(arguments -> {
...
/*    */             ConfigcommandopenProcedure.execute((LevelAccessor)world, x, y, z, (Entity)fakePlayer);
/*    */             return 0;
/*    */           }));
/*    */   }
/*    */ }
...
/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3-forge-1.20.1.jar!\net\mcreator\interpritation\command\TbsConfigCommand.class
