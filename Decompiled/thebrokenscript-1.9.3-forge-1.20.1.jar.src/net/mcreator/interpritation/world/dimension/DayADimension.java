...
/*    */ 
/*    */ import net.mcreator.interpritation.procedures.DayAPlayerEntersDimensionProcedure;
...
/*    */ 
/*    */ @EventBusSubscriber
/*    */ public class DayADimension {
/*    */   @EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
/*    */   public static class DayASpecialEffectsHandler
/*    */   {
/*    */     @SubscribeEvent
/*    */     @OnlyIn(Dist.CLIENT)
...
/*    */           }
/*    */         };
/* 39 */       event.register(new ResourceLocation("thebrokenscript:day_a"), customEffect); }
/*    */   
/*    */   }
/*    */   
/*    */   @SubscribeEvent
...
/* 50 */     if (event.getTo() == ResourceKey.m_135785_(Registries.f_256858_, new ResourceLocation("thebrokenscript:day_a")))
/* 51 */       DayAPlayerEntersDimensionProcedure.execute((LevelAccessor)world, x, y, z, (Entity)player); 
/*    */   }
/*    */   
...
/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3-forge-1.20.1.jar!\net\mcreator\interpritation\world\dimension\DayADimension.class
