...
/*     */ import net.mcreator.interpritation.procedures.CircuitTpBeaconOnInitialEntitySpawnProcedure;
...
/*     */ 
/*     */ public class CircuitTpBeaconEntity extends Monster {
/*     */   public CircuitTpBeaconEntity(PlayMessages.SpawnEntity packet, Level world) {
/*  42 */     this((EntityType<CircuitTpBeaconEntity>)ThebrokenscriptModEntities.CIRCUIT_TP_BEACON.get(), world);
/*     */   }
/*     */   
/*     */   public CircuitTpBeaconEntity(EntityType<CircuitTpBeaconEntity> type, Level world) {
/*  46 */     super(type, world);
/*  47 */     m_274367_(0.6F);
/*  48 */     this.f_21364_ = 0;
/*  49 */     m_21557_(false);
...
/* 101 */     CircuitTpBeaconOnInitialEntitySpawnProcedure.execute((LevelAccessor)world, m_20185_(), m_20186_(), m_20189_(), (Entity)this);
/* 102 */     return retval;
/*     */   }
/*     */   
/*     */   public static void init() {
/* 106 */     SpawnPlacements.m_21754_((EntityType)ThebrokenscriptModEntities.CIRCUIT_TP_BEACON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> 
...
/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3-forge-1.20.1.jar!\net\mcreator\interpritation\entity\CircuitTpBeaconEntity.class
