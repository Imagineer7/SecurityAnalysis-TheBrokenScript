...
/*     */ import net.mcreator.interpritation.procedures.HerobrineOnEntityTickUpdateProcedure;
/*     */ import net.mcreator.interpritation.procedures.HerobrineOnInitialEntitySpawnProcedure;
...
/*  49 */     this((EntityType<HerobrineEntity>)ThebrokenscriptModEntities.HEROBRINE.get(), world);
/*     */   }
/*     */   
...
/* 149 */     HerobrineOnInitialEntitySpawnProcedure.execute((LevelAccessor)world, m_20185_(), m_20186_(), m_20189_(), (Entity)this);
/* 150 */     return retval;
/*     */   }
/*     */ 
/*     */   
/*     */   public void m_6075_() {
/* 155 */     super.m_6075_();
/* 156 */     HerobrineOnEntityTickUpdateProcedure.execute((LevelAccessor)m_9236_(), m_20185_(), m_20186_(), m_20189_(), (Entity)this);
/*     */   }
/*     */ 
/*     */   
...
/* 173 */     SpawnPlacements.m_21754_((EntityType)ThebrokenscriptModEntities.HEROBRINE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> 
/* 174 */         (world.m_46791_() != Difficulty.PEACEFUL && Monster.m_219009_(world, pos, random) && Mob.m_217057_(entityType, (LevelAccessor)world, reason, pos, random)));
/*     */   }
/*     */   
/*     */   public static AttributeSupplier.Builder createAttributes() {
/* 178 */     AttributeSupplier.Builder builder = Mob.m_21552_();
/* 179 */     builder = builder.m_22268_(Attributes.f_22279_, 0.0D);
/* 180 */     builder = builder.m_22268_(Attributes.f_22276_, 910.0D);
/* 181 */     builder = builder.m_22268_(Attributes.f_22284_, 10.0D);
/* 182 */     builder = builder.m_22268_(Attributes.f_22281_, 13.0D);
/* 183 */     builder = builder.m_22268_(Attributes.f_22277_, 1916.0D);
/* 184 */     builder = builder.m_22268_(Attributes.f_22278_, 10.0D);
/* 185 */     builder = builder.m_22268_(Attributes.f_22282_, 10.0D);
/* 186 */     return builder;
/*     */   }
/*     */ }


/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3-forge-1.20.1.jar!\net\mcreator\interpritation\entity\HerobrineEntity.class
