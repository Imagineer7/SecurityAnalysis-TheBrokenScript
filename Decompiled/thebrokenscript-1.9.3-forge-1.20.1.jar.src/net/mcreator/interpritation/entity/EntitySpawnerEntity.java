...
/*     */ import net.mcreator.interpritation.procedures.EntitySpawnerOnEntityTickUpdateProcedure;
/*     */ import net.mcreator.interpritation.procedures.EntitySpawnerOnInitialEntitySpawnProcedure;
...
/*     */ 
/*     */ 
/*     */ public class EntitySpawnerEntity
/*     */   extends Monster
/*     */ {
/*     */   public EntitySpawnerEntity(PlayMessages.SpawnEntity packet, Level world) {
/*  49 */     this((EntityType<EntitySpawnerEntity>)ThebrokenscriptModEntities.ENTITY_SPAWNER.get(), world);
/*     */   }
/*     */   
...
/* 149 */     EntitySpawnerOnInitialEntitySpawnProcedure.execute((LevelAccessor)world, m_20185_(), m_20186_(), m_20189_(), (Entity)this);
/* 150 */     return retval;
/*     */   }
/*     */ 
/*     */   
/*     */   public void m_6075_() {
/* 155 */     super.m_6075_();
/* 156 */     EntitySpawnerOnEntityTickUpdateProcedure.execute((LevelAccessor)m_9236_(), (Entity)this);
/*     */   }
/*     */ 
/*     */   
...
/* 165 */     EntitySpawnerEntity entitySpawnerEntity = this;
/* 166 */     return false;
/*     */   }
/*     */ 
/*     */   
...
/* 183 */     SpawnPlacements.m_21754_((EntityType)ThebrokenscriptModEntities.ENTITY_SPAWNER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> 
/* 184 */         (world.m_46791_() != Difficulty.PEACEFUL && Monster.m_219009_(world, pos, random) && Mob.m_217057_(entityType, (LevelAccessor)world, reason, pos, random)));
/*     */   }
/*     */   
/*     */   public static AttributeSupplier.Builder createAttributes() {
/* 188 */     AttributeSupplier.Builder builder = Mob.m_21552_();
/* 189 */     builder = builder.m_22268_(Attributes.f_22279_, 0.3D);
/* 190 */     builder = builder.m_22268_(Attributes.f_22276_, 610.0D);
/* 191 */     builder = builder.m_22268_(Attributes.f_22284_, 0.0D);
/* 192 */     builder = builder.m_22268_(Attributes.f_22281_, 3.0D);
/* 193 */     builder = builder.m_22268_(Attributes.f_22277_, 716.0D);
/* 194 */     return builder;
/*     */   }
/*     */ }


/* Location:              C:\Users\Caleb\Downloads\thebrokenscript-1.9.3-forge-1.20.1.jar!\net\mcreator\interpritation\entity\EntitySpawnerEntity.class
